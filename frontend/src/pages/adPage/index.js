...
const Page = () => {
    ...
    const formatDate = (date) => {
        ...
        let currenteDay = currentDate.getDay()
        let currentMonth = currentDate.getMonth()
        let currentYear = currentDate.getFullYear()

        return `${currenteDay} de ${months[currentMonth]} de ${currentYear}`
    }
    return(
        <PageContainer>
            ...
            <OthersArea>
                {adInfo.others &&
                    <>
                        ...
                        <div className="list">
                            {adInfo.others.map( (other, key) => 
                                <AdItem key={key} data={other} />
                            )
